...
public class Almacen {
    ...
    public void busquedaMedica(String medi) {
    	int i = 0;
    	while(i < listaMedicamentos.size() && (medi.compareToIgnoreCase(listaMedicamentos.get(i))) != 0) {
    		i++;
    	}
    	if(i > listaMedicamentos.size()-1) {
    		System.out.println("El medicamkento no se encuentra");    	
    	}else {
    		System.out.println(listaMedicamentos.get(i));
    	}
    }
